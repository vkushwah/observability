...
// import { Configuration } from '../../application_analytics/components/configuration';
import {
  TAB_CONFIG_ID,
  TAB_CONFIG_TITLE,
  TAB_LOG_ID,
...
// import { ServiceDetailFlyout } from '../../application_analytics/components/flyout_components/service_detail_flyout';
import { SpanDetailFlyout } from '../../../../../public/components/trace_analytics/components/traces/span_detail_flyout';
// import { TraceDetailFlyout } from '../../application_analytics/components/flyout_components/trace_detail_flyout';
// import { fetchAppById, initializeTabData } from '../../application_analytics/helpers/utils';
...
export function Nginx() {
    ...
    getAppAnalyticsTab({
      ...
      <EuiText>
        <p>{TAB_OVERVIEW_TITLE}
          Monosodium glutamate (MSG, also known as sodium glutamate) is the sodium salt of
          glutamic acid, one of the most abundant naturally occurring non-essential amino acids.
  ...
  //   return appAnalyticsTabs.find((obj) => obj.id === selectedTabId)?.content;
  // }, [selectedTabId]);

  // const renderTabs = () => {
  //   return appAnalyticsTabs.map((tab, index) => (
  //     <EuiTab
  //       key={index}
  //       // href={tab.href}
      ...
      <EuiPage>
        <EuiPageBody component="div">
          <EuiPageHeader>
            <EuiPageHeaderSection>
              <EuiTitle size="l">
                <h1 data-test-subj="applicationTitle">{'Nginx'}</h1>
              </EuiTitle>
              <EuiText>
                <p>{'Nginx Description'}</p>
              </EuiText>
            </EuiPageHeaderSection>
          </EuiPageHeader>
          <EuiTabbedContent
