...
import { LogConfig } from '../../application_analytics/components/config_components/log_config';
...
export const CreateApp = (props: CreateAppProps) => {
  ...
  const editMode = false; // existingAppId !== 'undefined';
      ...
      <EuiPage>
        <EuiPageBody component="div">
          <EuiPageHeader>
            <EuiPageHeaderSection>
              <EuiTitle data-test-subj="createPageTitle" size="l">
                <h1>
                  {editMode ? 'Edit' : 'Create'} {appName} application
                </h1>
              </EuiTitle>
            </EuiPageHeaderSection>
          </EuiPageHeader>
          ...
          <EuiPageContent id="composition">
            ...
            <EuiHorizontalRule />
            {/* <LogConfig editMode={editMode} setIsFlyoutVisible={setIsFlyoutVisible} /> */}
            <EuiHorizontalRule />
            {/* <ServiceConfig
